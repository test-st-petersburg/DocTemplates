...
module.exports = {
  rules: {
    // Тело сообщения об изменении должно начинаться с пустой строки
    "body-leading-blank": [2, "always"],

    // Нижний колонтитул сообщения об изменении должен начинаться с пустой строки
    ...
    // Перечислим все возможные области изменений
    'scope-enum': [
      1,
      'always',
    ...
    // Перечислим все возможные варианты изменений
    "type-enum": [
      2,
      "always",
