...
- зависимости для сборки устанавливаем через PSDepend
  ([#34](https://github.com/test-st-petersburg/DocTemplates/issues/34))
- Saxon HE устанавливаем и используем локально (./tools/packages/)
