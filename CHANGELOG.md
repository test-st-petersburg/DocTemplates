...
- включена опция `IgnoreFirstLineIndentInNumbering` для исключения влияния
  параметров отступов в стиле списка на нумеруемые абзацы
  [#96](https://github.com/test-st-petersburg/DocTemplates/issues/96)
