...
- восстановлены DTD в XML файлах документов
  [#42](https://github.com/test-st-petersburg/DocTemplates/issues/42)
...
- дата регистрации с/з в Центр не помещалась при печати на листе
  [#40](https://github.com/test-st-petersburg/DocTemplates/issues/40)
