<?xml version="1.0" encoding="UTF-8"?><xsl:package version="3.0"
	id="OOInlineWriter"
	name="http://github.com/test-st-petersburg/DocTemplates/tools/xslt/OODocumentProcessor/oo-inline-writer.xslt"
...
>
	...
	<xsl:template mode="p:create-inline-document-files" match="/">
