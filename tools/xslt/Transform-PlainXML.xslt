...
>
	...
	<xsl:use-package name="http://github.com/test-st-petersburg/DocTemplates/tools/xslt/OODocumentProcessor/oo-document.xslt" package-version="2.3">
		<xsl:accept component="template" names="p:prepare-after-unpacking" visibility="final"/>
		<xsl:accept component="template" names="p:optimize" visibility="final"/>
		<xsl:accept component="template" names="p:preprocess" visibility="final"/>
		<xsl:accept component="template" names="p:prepare-for-packing" visibility="final"/>
	</xsl:use-package>
